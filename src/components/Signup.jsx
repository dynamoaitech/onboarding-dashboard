...
export default function Signup({ onSuccess, onNavigate }) {
  ...
  return (
    <div className="w-full max-w-md bg-white rounded-xl shadow-lg p-8">
      ...
      <p className="text-center text-slate-500 text-sm mb-6">Start your onboarding journey</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="bg-blue-50 border border-blue-200 px-4 py-3 rounded-lg text-sm text-slate-700">
